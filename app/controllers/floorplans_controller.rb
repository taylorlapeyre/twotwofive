class FloorplansController < ApplicationController
  before_action :set_floorplan, only: [:show, :update, :destroy, :edit]
  ...
  private 
    ...
    def floorplan_params
      params.require(:floorplan).permit(:name, :listing_id, :num_bathrooms, :num_bedrooms, :rent, :rent_type, :square_footage, :deposit, :lease_term, :lease_type, :feature_list)
    end
